...
del /q/s/f %HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT\*.*

mkdir %HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT\
mkdir %HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT\graphics
mkdir %HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\TEMP
mkdir %HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT




rem *** 1. Copy current Arbortext document (XML or SGML) to appropriate Honeywell XSL-FO "XML_INPUT" folder
copy %1 "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT"
copy %2 "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT\graphics"

rem *** Delete "filename.xml.CONSOLIDATED.xml" after copy steps complete ***
del %1


rem *** 2. RUN XSL-FO process: "..\..\Honeywell_XSL-FO\S1000D_EM_DRIVER\RUN_S1000D.bat"

rem *** Note: main XSL-FO BAT resides in relative path location on network drive ***
cd "..\..\..\Honeywell_XSL-FO\S1000D_EM_DRIVER"
cls
call RUN_S1000D_EM.bat
...
copy "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT\%3" "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT\%6"
copy "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT\%6" %4

rem *** Delete "*.xml.CONSOLIDATED.pdf"
del "%HONEYWELL_PRINT_CLIENT%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT\%3"
