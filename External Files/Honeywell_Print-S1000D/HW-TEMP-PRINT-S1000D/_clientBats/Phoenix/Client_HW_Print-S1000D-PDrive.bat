...
set HONEYWELL_PRINT_CLIENT=P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%

mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_DRIVER
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_DRIVER\TEMP
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_DRIVER\PDF_OUTPUT
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_DRIVER\XML_INPUT
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EIPC_DRIVER
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EIPC_DRIVER\TEMP
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EIPC_DRIVER\PDF_OUTPUT
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EIPC_DRIVER\XML_INPUT
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EM_DRIVER
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EM_DRIVER\TEMP
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EM_DRIVER\PDF_OUTPUT
mkdir P:\Print_Tools\HW-TEMP-PRINT-S1000D\%USERNAME%\Honeywell_XSL-FO\S1000D_EM_DRIVER\XML_INPUT
