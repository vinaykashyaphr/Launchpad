...
set JAVA_HELPER=h:\Projects\NEXTER\sonovision-helper.jar;
...
set SAXON9_CMD="%JAVA_CMD%" -Xms200M -Xmx200M -cp "%SAXON9_HOME%";"%JAVA_HELPER%" net.sf.saxon.Transform
...
%SAXON9_CMD% -o "h:\Projects\NEXTER\saxonExportTest.xml" "h:\Projects\NEXTER\DMC-HON97896-A-34-41-71-06A-941A-C_001-00_sx-US.xml" "h:\Projects\NEXTER\02-S1000D-references-saxon.xsl"
