...
#
#  -------------------
#  Last Modified: 2019-06-06, 1:54 p.m.
#  By: smainuddin
#
...
def Finalize(data, data2, filename, directory):                                                                                              # Outputs to a CSV.
    jip[directory.name].log_print("Checklist Output...")
    PDFname = filename
    data2.to_csv(str(PDFname).replace(".pdf", "_Checklist.csv"), index=False, encoding='utf-8')


def QA_MAKER(offset):
    Error_Code =   ['CID-1', 'CID-2',
                             'CRF-1', 'DPL-3',
                             'Fig-1', 'Fig-2',
                             'Fig-3', 'MEA-1',
                             'NOM-1', 'PN-1',
                             ...
                             'ERR-26', 'ERR-27', 'ERR-28', 'ERR-29', 'ERR-30', 'ERR-31', 'ERR-32', 'ERR-33',
                             'ERR-34', 'ERR-35', 'ERR-36', 'ERR-37', 'ERR-38', 'ERR-39', 'ERR-40',
                             'ERR-41', 'ERR-42', 'ERR-43', 'ERR-44', 'ERR-45', 'ERR-46', 'ERR-47', 'ERR-48', 'ERR-49',
                             'ERR-50', 'ERR-51', 'ERR-52', 'ERR-53', 'ERR-54', 'ERR-55', 'ERR-56', 'ERR-57', 'ERR-58',
                             'ERR-59', 'ERR-60','ERR-61', 'ERR-62',  'ERR-63', 'ERR-64', 'ERR-65', 'ERR-65', 'ERR-66',
                             'Total Page Number', 'Date', 'Name']
    Error_Code.insert(offset, '---')

    Highlight = ['Missing Highlight/Revision bar', 'Incorrect LEP', 'Incorrect/Missing Cross Reference',
                        ...
                        'CAPU TPCR Statement', 'Check PDF Name Format', 'Replace Volts and Watts', 'Page Date Missing',
                        'Page Number Missing', 'Incorrect LEP Date', 'Missing Asterisks', 'Missing Page on LEP',
                        'Missing Graphics', 'Acronym Repeated', 'Missing Blank Foldout Page', "Even Numbered Foldout",
                        'Ends on Odd Numbered Page', 'Incomplete Verification Table', "Honeywell Asca Inc.",
                        'Graphic Highlight Missing', 'Paragraph Highlights Missing', 'Title Highlight Missing', 'Website Link',
                        ...
                        '\"Significant\"',
                        '-', "-", "-"]
    errors = {'Error': Error_Code, 'Error Code': Highlight}
