...
rem *** % 2 = $type of current XML file (e.g. "cmm", "em", etc. - passed by ACL script)
...
rem *** Updated to add the document type as a parameter
...
%SAXON9_CMD% -t -o %1.xmx %1 01-S1000D-consolidate.xsl type=%2 variant=%3
