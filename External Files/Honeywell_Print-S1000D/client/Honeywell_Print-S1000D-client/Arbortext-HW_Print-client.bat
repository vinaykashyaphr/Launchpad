taskkill /im editor.exe /f >nul 2>&1
...
rem *** 32-bit ***
if exist "%ARBORTEXT_HOME%\bin\x86\editor.exe" set ARBORTEXT_CMD="%ARBORTEXT_HOME%\bin\x86\editor.exe"  -newinstance

rem *** 64-bit ***
if exist "%ARBORTEXT_HOME%\bin\x64\editor.exe" set ARBORTEXT_CMD="%ARBORTEXT_HOME%\bin\x64\editor.exe"  -newinstance

rem *** Launch Arbortext Editor ***
rem %ARBORTEXT_CMD% -editor

rem *** Launch Arbortext Styler ***
%ARBORTEXT_CMD% -styler
