...
set XSLT_HELPER=%XML_DIR_LISTING_HOME%\sonovision-helper.jar
set S1000D_HELPER=S1000DHelper.jar
set SAXON9_HOME=%ARBORTEXT_HOME%\lib\classes\saxon.jar
set SAXON9_CMD="%JAVA_CMD%" -Xms200M -Xmx200M -cp "%SAXON9_HOME%";"%XSLT_HELPER%";"%S1000D_HELPER%" net.sf.saxon.Transform
